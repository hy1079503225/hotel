...
public class SendMail {
    ...
    public static String sendEmailAccount = "2350470353@qq.com";
    // 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
    public static String sendEmailPassword = "lzstrhqbmdxsdjbf";
    // 发件人邮箱的SMTP服务器地址，如：smtp.163.com
    public static String sendEmailSMTPHost = "smtp.qq.com";
    // 收件人的邮箱账号
    public static String receiveMailAccount = "1485678609@qq.com";
